...
|--|--|
|产品名称|速速会议笔记|
|产品描述|一款利用手写文字识别，实时语音识别和音频转文本技术让公司职员在会议中能够快速记录，会议后完善报告节约时间，节省精力的APP|
|产品版本|1.0|
|文件现状|进行中|
|文件作者|金琳|

## 加值宣言
公司内部开会议，做笔记，写报告已是常态；尤其是公司大会时，领导众多，发言风格迥异，内容冗长，听报告的职员不能不得一直在现场全神贯注，生怕错过了领导讲述内容的重点。实时语音识别api技术帮助职员解决领导带口音发言听不懂无法记录的窘境；错过和不全程呆在会议的职员或重大会议发言记录怕有疏漏的职员可利用保存下的音频，利用音频转文本api快速便捷的回顾会议内容；会议结束后，习惯手写会议记录的职员可利用手写文字识别api快速将其转化为电子文本，大大缩短撰写会议记录报告的时间。
